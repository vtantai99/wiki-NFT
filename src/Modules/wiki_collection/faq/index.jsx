...
const FAQ = () => {
  ...
  const { changeFAQAction, faq } = useWikiCollect()
  const { data, isSubmitting } = faq

  const onSubmit = (formData) => {
    changeFAQAction({ data: formData, name: 'fan photo', callback: () => setIsEdit(false) })
  }
  ...
  return (
    ...
    >
      <TextNormal fontWeight="fw_700">Did you know? / FAQ</TextNormal>
      <Wrapper>
        <FormProvider {...form}>
          <div className="faq">
            {isEdit ? (
