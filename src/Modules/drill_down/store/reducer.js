...
import { DILL_DOWN } from './text'

export const initialState = {
    collectDes: {
        isSubmitting: false,
        data: DILL_DOWN.COLLECT_DES,
        error: null
    },
    tags: {
        isSubmitting: false,
    ...
    roadMap: {
        isSubmitting: false,
        data: DILL_DOWN.ROAD_MAP,
        error: null
    },
    notable_holders: {
        isSubmitting: false,
        data: DILL_DOWN.NOTABLE_HOLDER,
        error: null
    },
    team: {
        isSubmitting: false,
    ...
    trivia: {
        isSubmitting: false,
        data: DILL_DOWN.TRIVIA,
        error: null
    },
    previousOwners: {
        isSubmitting: false,
        data: DILL_DOWN.PREVIOUS_OWNER,
        error: null
    }
...
function changePreviousOwners(state) {
    return updateObject(state, {
        previousOwners: {
...
function changePreviousOwnersSuccess(state, { data }) {
    return updateObject(state, {
        previousOwners: {
            ...state.previousOwners,
            isSubmitting: false,
...
export default createReducer(initialState, {
    ...
    [REQUEST(CHANGE_PREVIOUS_OWNERS)]: changePreviousOwners,
    [SUCCESS(CHANGE_PREVIOUS_OWNERS)]: changePreviousOwnersSuccess
})